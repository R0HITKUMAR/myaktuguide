...
var url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS2gFp_98dMn1dGMRBLatZlgW6080fs96U7nG_N9CuOQuHkUBDZ3Sc3pZ--bNvrWv5N2ddd_hM5C2I_/pub?gid=1559320963&single=true&output=csv';
$(document).ready(function () {
    $.ajax({
        ...
        success: function (data) {
            ...
            table_data += '</table>';
            $('#practical_table').html(table_data);
        }
    });
});
